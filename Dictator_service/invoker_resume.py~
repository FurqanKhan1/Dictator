...
Objective :
The purpose of this file /module /Class is to resume the discovery process.It invokes the gui_main_class_based.py file with relevent switches in order to resume an earlier paused scan
"""
